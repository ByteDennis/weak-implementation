...
class BaseTorchModel(BaseModel, ABC):
    ...
    def _init_optimizer_and_lr_scheduler(self,
        ...
        if optimizer == 'default':
            optimizer_ = Adafactor(parameters, lr=optimizer_config['lr'], weight_decay=optimizer_config.get('weight_decay', 0.0))
        else:
    ...
    def _init_valid(self,
        ...
        assert direction in ['maximize', 'minimize'], 'direction should be in ["maximize", "minimize"]!'
