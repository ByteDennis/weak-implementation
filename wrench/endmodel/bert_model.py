...
from transformers import Adafactor, get_linear_schedule_with_warmup, AutoTokenizer
...
class BertClassifierModel(BaseTorchClassModel):
    ...
    def fit(self,
        ...
        optimizer = Adafactor(model.parameters(), lr=hyperparas['lr'], weight_decay=hyperparas['l2'])
